...
FORWARD_CHANNEL_ID = -1001945226666
CHANNEL_ID = -1001945226666
error_channel_id = -1001945226666
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: @MagnumCheat.*", parse_mode='Markdown')  # Contact owner message
            return
